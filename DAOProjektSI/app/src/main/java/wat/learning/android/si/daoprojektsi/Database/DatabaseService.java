...
public class DatabaseService extends IntentService implements Database {
    ...
    private String connectionURL = "jdbc:jtds:sqlserver://projektsi.database.windows.net:1433/projektSI;"
    ...
    public void UserLogin(String email, String seed, String hashPassword) {
        String userLoginQuery = "SELECT IdLokatora FROM Lokator WHERE Email=N'" + email + "' AND Haslo='" + hashPassword +"';";
